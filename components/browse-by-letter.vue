<template>
  <section class="py-10 w-11/12 mx-auto rounded-2xl alphabet-section">
    <div class="container mx-auto px-4 mt-4">
      <h3 class="text-3xl md:text-4xl font-bold text-center text-black">
        Sfoglia le <span class="text-blu">monografie</span>, lettera per lettera
      </h3>
      <div class="w-11/12 md:w-9/12 mx-auto flex justify-center mt-8 items-center">
      ...
      <div class="w-11/12 md:w-9/12 mx-auto flex overflow-x-auto mt-10 gap-4 px-4 pb-6" style="scroll-padding-right: 30px;">
        ...
        <template v-else>
          ...
          >
            ...
            <h3 class="italic text-gray-400">{{ post.nomeScientifico }}</h3>
          </div>
        </template>
      </div>
    </div>
